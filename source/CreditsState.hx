...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['PescadinCringe',		'Sin_titulo-1-1',	'New chile logo, drew the chile option',				'https://twitter.com/pescacrinch',		'FFFFFF'],
			['Theomag',				'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx','Animated metal Sonic and Sonic',		'https://twitter.com/TheoMag_',			'FFFFFF'],
			['Sic',					'sic',				'Composer of pico and menu chile remix',				'https://twitter.com/SicTheHedgehog',	'FFFFFF'],
			[''],
			['Psych Engine Team'],
